...
def compute_local_demand_supply(data: dict[str, Any], thresholds: DemandSupplyThresholds = DEFAULT_THRESHOLDS) -> dict[str, Any]:
    ...
    output: dict[str, Any] = {
        ...
        "current_cbdc_approved_places": _round(current_places),
        "current_cbdc_service_count": _round(_number(_input(working, "current_cbdc_service_count"))),
        "approved_places_source": _input(working, "approved_places_source"),
        "approved_places_confidence": _input(working, "approved_places_confidence"),
        "current_child_per_place": _round(current_child_per_place),
        "proposed_new_places": _round(proposed_places),
